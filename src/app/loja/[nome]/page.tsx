...
const SaleProduct = () => {
    ...
    return (
        ...
        <div className="flex flex-col bg-white font-fontePrimaria">
            ...
            justify-center text-black font-fontePrimaria">
                <div className="flex xl:flex-row flex-col items-center xl:gap-[10px]">
                    <img
                        src={`/images/produtos/${produto?.nome}.png`}
                        alt="imagem do produto"
                        className="xl:w-auto xl:h-[400px] w-[300px] h-[300px] rounded shadow-2xl"
                    />
                
                </div>
                <div className="flex flex-col xl:gap-[10px]">
                    <h1 className="xl:text-[32px] text-[28px]"> {produto?.nome} </h1>
                    <p className="xl:text-[32px] text-[24px]"> R$ {produto?.preco} </p>
